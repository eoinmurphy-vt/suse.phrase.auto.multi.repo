= Ressources de l'horaire
:revdate: 2025-10-10
:page-revdate: {revdate}

La ressource `Schedule` définit les fenêtres temporelles pendant lesquelles {product_name} accepte les modifications apportées à `Clusters`.

Pour plus d'informations sur l'utilisation de la ressource `Schedule`, reportez-vous à la rubrique xref:experimental-features/scheduling.adoc[Planification].
