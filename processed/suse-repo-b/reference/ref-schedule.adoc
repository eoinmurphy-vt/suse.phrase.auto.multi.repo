...
The `+Schedule+` resource defines time windows during which {product_name} accepts changes to `+Clusters+`.

For more information on how to use the `+Schedule+` resource, refer to xref:experimental-features/scheduling.adoc[Scheduling].
