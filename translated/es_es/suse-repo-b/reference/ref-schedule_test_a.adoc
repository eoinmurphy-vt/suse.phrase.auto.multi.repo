...
El recurso `+Schedule+` define ventanas de tiempo durante las cuales {product_name} acepta cambios en `+Clusters+`.

Para más información sobre cómo utilizar el recurso `+Schedule+`, consulte xref:experimental-features/scheduling.adoc[Programación].
